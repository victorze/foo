...
" Colors base
let s:primary       =   '#bbbbbb'
let s:secondary     =   '#bbbbbb'
...
call s:hi('Type', '#bbbbbb', s:bg, s:none)
...
call s:hi('ColorColumn', s:source, '#121a21', s:none)

" Interface highlighting
call s:hi('Normal', s:source, s:bg, s:none)
call s:hi('Visual', s:none, '#1a2632', s:none)
...
call s:hi('VertSplit', '#121a21', s:bg, s:none)
call s:hi('Title', s:scalar, s:bg, s:none)
call s:hi('Pmenu', s:source, '#121a21', s:none)
...
call s:hi('jsDot', s:source, s:bg, s:none)
...
call s:hi('jsxTagName', '#bbbbbb', s:bg, s:none)
call s:hi('jsxAttrib', s:scalar, s:bg, s:none)
call s:hi('jsxPunct', '#bbbbbb', s:bg, s:none)
call s:hi('jsxCloseString', '#bbbbbb', s:bg, s:none)
call s:hi('jsxComponentName', '#bbbbbb', s:bg, s:none)
...
call s:hi('htmlTag', '#bbbbbb', s:bg, s:none)
call s:hi('Identifier', '#bbbbbb', s:bg, s:none)
call s:hi('htmlArg', s:scalar, s:bg, s:none)

" CSS
call s:hi('cssTagName', s:red, s:bg, s:none)
call s:hi('cssClassNameDot', s:secondary, s:bg, s:none)
call s:hi('cssClassName', s:secondary, s:bg, s:none)
